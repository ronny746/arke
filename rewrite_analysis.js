    ...
    <div className="space-y-6 animate-fade-in p-2 md:p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="p-6 bg-white flex flex-col justify-center items-center text-center border-gray-100 shadow-sm">
          ...
          <div className="text-4xl font-bold mt-2 text-gray-900">{formatTime(session.totalTimeSpentSeconds || 0)}</div>
        </Card>
      </div>
...
fs.writeFileSync('src/app/admin/dpp/[id]/analysis/page.tsx', content);
fs.writeFileSync('src/app/teacher/dpp/[id]/analysis/page.tsx', content);
