        ...
        const actions = [
          {
            icon: Edit,
            label: 'Edit Exam',
            onClick: () => navigate(`/admin/exams/${row._id}/edit`)
          },
          {
            icon: FileCheck,
            label: 'Live Monitor',
            onClick: () => navigate(`/admin/exams/${row._id}/monitor`)
          },
          {
            icon: FileText,
            label: 'View Results',
            onClick: () => navigate(`/admin/exams/${row._id}/results`)
          }
        ];
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader
        ...
        actions={<Button variant="gradient" icon={Plus} onClick={() => navigate('/admin/exams/create')}>Create Exam</Button>}
      />
