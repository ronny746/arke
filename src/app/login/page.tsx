      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8 flex flex-col items-center">
          <img 
            src="/arke_logo.png" 
            alt="ARKE Scholars" 
            className="h-12 w-auto object-contain dark:hidden mb-2"
          />
          <img 
            src="/arke_logo_light.png" 
            alt="ARKE Scholars" 
            className="h-12 w-auto object-contain hidden dark:block mb-2"
          />
          <p className="text-surface-500 dark:text-surface-400 font-medium text-sm">Sign in to your ARKE Scholars account</p>
        </div>
