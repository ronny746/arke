    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="sm" onClick={() => router.push(`/teacher/students/${row.student?._id || row.student?.id || (typeof row.student === 'string' ? row.student : '')}/performance`)} icon={LineChart}>
            Overall
          </Button>
