        ...
        const actions = [
          {
            icon: Edit,
            label: 'Edit Exam',
            onClick: () => router.push(`/admin/exams/${row._id}/edit`)
          },
          {
            icon: FileCheck,
            label: 'Live Monitor',
            onClick: () => router.push(`/admin/exams/${row._id}/monitor`)
          },
          {
            icon: FileText,
            label: 'View Results',
            onClick: () => router.push(`/admin/exams/${row._id}/results`)
          }
        ];
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader
        ...
        actions={<Button variant="gradient" icon={Plus} onClick={() => router.push('/admin/exams/create')}>Create Exam</Button>}
      />
