...
import { BookOpen, Clock, CheckCircle2, Trophy, ArrowRight, X, Loader2, LogOut } from 'lucide-react';
          ...
          <div className="flex items-center gap-4">
            ...
            {user ? (
              <div className="flex items-center gap-3">
                ...
                <button onClick={handleLogout} className="p-2 text-gray-400 hover:text-red-500 transition-colors rounded-lg hover:bg-red-50" title="Logout">
                  <LogOut size={18} />
                </button>
              </div>
            ) : (
              <div className="flex items-center gap-3">
                <button onClick={() => setIsLoginModalOpen(true)} className="text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 px-5 py-2.5 rounded-xl transition-all shadow-md">
                  Login / Sign up
                </button>
              </div>
            )}
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center justify-between p-3 sm:p-4 rounded-xl bg-gray-50 border border-gray-100">
                    ...
                    <span className="font-bold text-gray-900">{course.duration || 'N/A'}</span>
                  </div>
                ...
                {isEnrolled ? (
                  ...
                  <button onClick={handleBuyClick}
                    ...
                    {user ? 'Enroll Now' : 'Login / Register to Enroll'} 
                    <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
                  </button>
                )}
